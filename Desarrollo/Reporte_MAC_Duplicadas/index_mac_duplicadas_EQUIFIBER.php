<?php
//$idPag = 'vista_mac_duplicadas_equifiber';
/* $idPag2 = '999';
...
<html>
    <head>
        <title>SN/MAC Duplicadas EQUIFIBER</title>
    </head>
    <body>
        <div class="row">
            <div class="col-md-12 text-center"><h3>ONUs con SN/MAC en m&aacute;s de un puerto &mdash; EQUIFIBER</h3></div>
        </div><br />
        <div class="row">
            <div class="col-md-12 text-center">
                <button type="button" class="btn btn-primary" onclick="generarReporte()">Generar Datos</button>
                &nbsp;
                <a id="btnExportar" href="../ONT/Reporte_MAC_Duplicadas/export_mac_duplicadas_EQUIFIBER.php" class="btn btn-success" style="display:none;">Exportar Excel</a>
            </div>
        </div><br />
        <div class="row">
...
function generarReporte() {
    ...
    $('#btnExportar').hide();
    $.post('../ONT/Reporte_MAC_Duplicadas/tabla_mac_duplicadas_EQUIFIBER.php', {}, function(data) {
