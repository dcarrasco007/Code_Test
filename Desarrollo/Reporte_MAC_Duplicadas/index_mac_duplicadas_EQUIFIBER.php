    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                &nbsp;
                <a id="btnExportar" href="export_mac_duplicadas_EQUIFIBER.php" class="btn btn-success" style="display:none;">Exportar Excel</a>
            </div>
        </div><br />
        <div class="row">
...
function generarReporte() {
    ...
    $('#btnExportar').hide();
    $.post('tabla_mac_duplicadas_EQUIFIBER.php', {}, function(data) {
