<?php
// Exporta el reporte de SN/MAC duplicadas (solo OLTs ONNET) a .xlsx (2 hojas),
...
$sheet->setTitle('MACs Duplicadas ONNET');
...
// Titulo
$sheet->setCellValue('A1', 'ONUs con SN/MAC en más de un puerto (ONNET) — Access ' . $fechaHoy);
...
$sheet2->setCellValue('A1', 'Resumen por Estado Running (ONNET)');
...
// ================== Descarga ==================
$nombreArchivo = 'MACs_duplicadas_ONNET_' . date('Ymd_His') . '.xlsx';
