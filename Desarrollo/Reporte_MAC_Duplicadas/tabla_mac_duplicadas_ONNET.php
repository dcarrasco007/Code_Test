<?php
// Reporte: ONUs con SN/MAC registrada en mas de un puerto (solo OLTs ONNET).
...
// El INNER JOIN contra OLT_SERVER_ONNET limita la deteccion de duplicados
// a los equipos ONNET (mismo patron que proceso_informacion.php).
...
$tabla .= "<div id='panelMacDup'>
        <div class='meta'>&Uacute;ltima generaci&oacute;n: $fechaHoy &nbsp;&bull;&nbsp; Total: $total SN/MAC en 2+ puertos (ONNET)</div>
