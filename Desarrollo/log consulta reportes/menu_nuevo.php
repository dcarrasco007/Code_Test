    ...
    <body>
    			...
    			<div class="menu">
    				<nav class="navbar navbar-default" style="padding-top: 0%;">
    					<div class="container-fluid">
                            ...
                            echo $menu_principal;
                            ?>
                            <!-- <form class="navbar-form navbar-left form-search form-inline" role="search">
    								<div class="form-group input-group">
    									<input type="text" id="nodo" placeholder="Nombre o IP Equipo OLT" class="form-control search-query" size="18">
    									<span class="input-group-btn">
    										<button  onclick="busca_info(); return false;" type="button" class="btn btn-primary">Buscar</button>
    									</span>
    								</div>
    							</form> -->
                                <div>
       ...
       <!-- Modal Editar -->
        ...
        function cambioPag(url){
            try { $.post('log_acceso.php', {u: url}); } catch(e) {}
            $('.contenido').hide();
