...
//-----------MONITOREO
$proceso_id=20;//ID DEL PROCESO YA REGISTRADO
...
while ($row = $result->fetch_array(MYSQLI_NUM)) {
    ...
    shell_exec("nohup php -f /var/www/procesos/php/Uptime_PHP8/proceso_data.php $ip $server $region $lote_id> /var/www/procesos/php/Uptime_PHP8/logs/logs-$ip-$server.log &");
