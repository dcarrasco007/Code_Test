...
/* $server='OLT-AVPHURTADONORTEPCS-2';
$ip='10.99.30.74';
$fecha='2025-05-28'; */
$semana=date('W');
    ...
    while($row2 = $resp2->fetch_array(MYSQLI_NUM)){
        $query3 = "SELECT server,ip,week, AVG(trafico),AVG(trafico_up)
            ...
            $week=$row3[2];
                ...
                $valorDown_1 = round($row3[3] / 1024, 2);
                $valorUp_1 = round($row3[4] / 1024, 2);
    ...
    if($promedios>0){
        ...
        $peak=round($peak,1);
        echo $query3 = "INSERT INTO OLT_TRAFICO_UPLINK_MA5800_X15_DAY (server, ip, promedio_trafico, peack_trafico, fecha, week, promedio_trafico_up, peack_trafico_up) VALUES
