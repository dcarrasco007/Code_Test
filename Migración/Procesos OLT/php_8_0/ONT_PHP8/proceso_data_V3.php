...
//print_r($detalle);
    if(trim($y)){
        if($y < 100){   
            ...
            if(isset($puertos[0])){
                ...
                obtenerData2($array1, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[1])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[1];
                obtenerData2($array2, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[2])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[2];
                obtenerData2($array3, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[3])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[3];
                obtenerData2($array4, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[4])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[4];
                obtenerData2($array5, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[5])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[5];
                obtenerData2($array6, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[6])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[6];
                obtenerData2($array7, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[7])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[7];
                obtenerData2($array8, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[8])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[8];
                obtenerData2($array9, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[9])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[9];
                obtenerData2($array10, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[10])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[10];
                obtenerData2($array11, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[11])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[11];
                obtenerData2($array12, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[12])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[12];
                obtenerData2($array13, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            if(isset($puertos[13])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[13];
                obtenerData2($array14, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion -----$puerto1\n";
            }
            if(isset($puertos[14])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[14];
                obtenerData2($array15, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
            if(isset($puertos[15])){
                 echo "\nPuerto a revisar por funcion-----$puerto1\n";
                $puerto1=$puertos[15];
                obtenerData2($array16, $server, $ip, $region,$comuna, $puerto1);
                echo "\nFin Puerto a revisar por funcion-----$puerto1\n";
            }
        }
    }
    ...
    function obtenerData2($log,$server,$ip,$region,$comuna, $puerto1){
        global $mysqli;
        global $puertas_vacias;
        global $puerto_funcion_global;

        $fecha_registro = date('Y-m-d 10:00:00', strtotime('+1 day'));
        $current_port = null;
        $section = 0;
        $ont_data = array();
           ...
           foreach($idsONT as $row ) {
            echo "\n**IDs: $row**\n";
                ...
                if($type!='5612' && $type!='SmartAX OT928G'){
                    ...
                    VALUES('$server', '$ip', '$auxpuerta[0]', '$auxpuerta[1]', '$auxpuerta[2]', '$row', '$estado', '$region', '$comuna', '$description', '$description', '$sn', '$OLT_Rx_ONT_power', '$tx_power', '$rx_power', '$voltage', '$temperature', '$up', '$down', '$distance', '$line_profile', '$service_profile', '$fecha_registro','$type');";
