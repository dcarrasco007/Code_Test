...
while ($row = $result_ip->fetch_array(MYSQLI_NUM)) {
    ...
    shell_exec("nohup php -f /var/www/procesos/php/Energia_CPU_PHP8/shell_energia_exped.php $ip $server $region $modelo $lote_id > /var/www/procesos/php/Energia_CPU_PHP8/log/$server.log &");
