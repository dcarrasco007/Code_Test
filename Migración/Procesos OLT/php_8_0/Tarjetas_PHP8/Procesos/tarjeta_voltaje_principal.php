...
while ($row = $result->fetch_array(MYSQLI_NUM)) {
    ...
    shell_exec("nohup php -f /var/www/procesos/php/Tarjetas_PHP8/Procesos/tarjeta_voltaje_exped.php $ip $server $region > /var/www/procesos/php/Tarjetas_PHP8/Procesos/logs/$ip.log &");
}    
//-----Hora
$sql_hora = "SELECT NOW()";
$resultHora = $mysqli->query($sql_hora) or die("error $sql_hora");
