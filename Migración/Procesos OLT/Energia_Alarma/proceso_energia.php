...
while ($row = $result->fetch_array(MYSQLI_NUM)) {
    ...
    shell_exec("nohup php -f /u01/crontab127/OLT/Energia_Alarma/proceso_data.php $ip $server $region $modelo $lote_id > /u01/crontab127/OLT/Energia_Alarma/logs/logs-$ip-$server.log &");
    echo $server."\n";
    //$ip = '10.99.17.24';
