...
while ($row = $result->fetch_array(MYSQLI_NUM)) {
        ...
        $tipo=$row[6];
            if($y < 100){    
                    shell_exec("nohup php -f /u01/crontab127/OLT/Alarmas/Procesos/proceso_los_ont_exped.php $ip $server $tipo $modelo $lote_id > /u01/crontab127/OLT/Alarmas/logs/log_los_ont/$server.log &");
            }
