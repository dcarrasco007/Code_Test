        ...
        if(trim($y)){
            if($y < 100){    
                if($ip == '10.99.24.68'){
                    ...
                    shell_exec("nohup php -f /u01/crontab127/OLT/Alarmas/Procesos/proceso_critical_exped.php $ip $server $tipo $modelo $lote_id > /u01/crontab127/OLT/Alarmas/logs/$ip.log &");
                }else{
                    $tipo=1;
