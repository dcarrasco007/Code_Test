...
while ($row = $result_ip->fetch_array(MYSQLI_NUM)) {
    ...
    $region = 'XIII';
    $modelo = 'MA5800-X15';*/
    shell_exec("nohup php -f /u01/crontab127/OLT/shell_temp_cpu_data.php $ip $server $region $modelo $lote_id > /u01/crontab127/OLT/Archivos/Logs_temperatura/$server.log &");
